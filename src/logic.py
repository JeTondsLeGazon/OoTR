...
mylogic = {
    ...
    "Twinrova": [
        ("isadult", 1),
        ("Progressive Strength Upgrade", [2]),
        ("Small Key (Spirit Temple)", [5]),
        ("Mirror Shield", 1),
        ("Progressive Hookshot", [1]),
        ("Bomb Bag", 1),
        ("Boss Key (Spirit Temple)", 1),
        ("has_access|Spirit", 1),
    ],
    ...
    "LH Sun": [
        [("isadult", 1), ("Bow", 1), ("Progressive Hookshot", 2)],
        [("isadult", 1), ("Bow", 1), ("Boss Key (Water Temple)", 1)],
    ],
    "LH Freestanding PoH": [
        [("Progressive Hookshot", [1]), ("isadult", 1)],
    ...
    "GF Chest": [
        [("isadult", 1), ("has_access|GTG", 1), ("Progressive Hookshot", [1])],
    ...
    "Wasteland Chest": [
        [("isadult", 1), ("has_access|GTG", 1), ("Magic Meter", 1), ("Dins Fire", 1)],
        [
            ("isadult", 1),
            ("has_access|GTG", 1),
            ("Magic Meter", 1),
    ...
    "Colossus Great Fairy Reward": [
        [("isadult", 1), ("Eponas Song", 1), ("Bomb Bag", 1)],
    ...
    "Market 10 Big Poes": [
        [("isadult", 1), ("Eponas Song", 1), ("Bow", 1), ("Bottle", 1)],
        [("isadult", 1), ("Big Poe", 1)],
    ],
    ...
    "GC Pot Freestanding PoH": [
        [("isadult", 0), ("Bomb Bag", 1), ("Zeldas Lullaby", 1)],
    ...
    "DMC Great Fairy Reward": [
        [("isadult", 1), ("Bow", 1), ("Megaton Hammer", 1), ("Zeldas Lullaby", 1)],
    ...
    "ZR Frogs in the Rain": [
        [("isadult", 0), ("Song of Storms", 1), ("Bomb Bag", 1)],
    ...
    "ZD King Zora Thawed": [
        ...
        [("isadult", 1), ("Bottle", 1), ("has_access|Trials", 1), ("has_spawn|ZD", 1)],
        [("isadult", 1), ("Bottle", 1), ("Rutos Letter", 2), ("Zeldas Lullaby", 1)],
        [("isadult", 1), ("Bottle", 1), ("Rutos Letter", 2), ("Hover Boots", 1)],
        [("isadult", 1), ("Bottle", 1), ("Rutos Letter", 2), ("has_spawn|ZD", 1)],
        [
            ("isadult", 1),
        ...
        [("isadult", 1), ("Progressive Wallet", 2), ("Bottle", 1), ("Hover Boots", 1)],
        [("isadult", 1), ("Progressive Wallet", 2), ("Bottle", 1), ("has_spawn|ZD", 1)],
    ],
    ...
    "ZF Bottom Freestanding PoH": [
        [("isadult", 1), ("Rutos Letter", 2), ("Zeldas Lullaby", 1), ("Iron Boots", 1)],
    ...
    "Fire Temple Boulder Maze Lower Chest": [
        ("isadult", 1),
        ("has_access|Fire", 1),
        ("Small Key (Fire Temple)", [3]),
    ],
    "Fire Temple Boulder Maze Upper Chest": [
        ("isadult", 1),
        ("has_access|Fire", 1),
        ("Small Key (Fire Temple)", [5]),
    ],
    ...
    "Fire Temple Map Chest": [
        [("isadult", 1), ("has_access|Fire", 1), ("Small Key (Fire Temple)", [5])],
        [
            ("isadult", 1),
            ("has_access|Fire", 1),
            ("Small Key (Fire Temple)", [4]),
            ("Bow", 1),
        ],
    ],
    ...
    "Ice Cavern Map Chest": [
        [("isadult", 1), ("Hover Boots", 1), ("Bottle", 1)],
    ...
    "Water Temple Torches Chest": [
        [("isadult", 1), ("has_access|Water", 1), ("Bow", 1), ("Zeldas Lullaby", 1)],
        [
            ("isadult", 1),
            ("has_access|Water", 1),
            ("Dins Fire", 1),
    ...
    "Water Temple Dragon Chest": [
        [("isadult", 1), ("Small Key (Water Temple)", [5]), ("Bow", 1)],
    ...
    "Gerudo Training Grounds Hidden Ceiling Chest": [
        ("isadult", 1),
        ("has_access|GTG", 1),
        ("Small Key (Gerudo Training Grounds)", [3]),
    ],
    "Gerudo Training Grounds Maze Path First Chest": [
        ("isadult", 1),
        ("has_access|GTG", 1),
        ("Small Key (Gerudo Training Grounds)", [4]),
    ],
    ...
    "Gerudo Training Grounds Maze Path Third Chest": [
        ("isadult", 1),
        ("has_access|GTG", 1),
        ("Small Key (Gerudo Training Grounds)", [7]),
    ],
    "Gerudo Training Grounds Maze Path Final Chest": [
        ("isadult", 1),
        ("has_access|GTG", 1),
        ("Small Key (Gerudo Training Grounds)", [9]),
    ],
    ...
    "Spirit Temple Child Bridge Chest": [
        [("Requiem of Spirit", 1), ("Boomerang", 1), ("isadult", 0)],
    ...
    "Spirit Temple Child Climb East Chest": [
        [("Small Key (Spirit Temple)", [1]), ("Bomb Bag", 1), ("has_access|Spirit", 1)],
        [
            ("Small Key (Spirit Temple)", [1]),
            ("Boomerang", 1),
            ("Bow", 1),
            ("has_access|Spirit", 1),
        ],
    ...
    "Ganons Castle Shadow Trial Front Chest": [
        [("has_access|Trials", 1), ("isadult", 1), ("Hover Boots", 1)],
...
dungeons_acess = {
    ...
    "Water": [
        [("isadult", 1), ("Progressive Scale", 2), ("Progressive Hookshot", 2)],
...
additionnal_actions = {
    ...
    "Deliver RL": (
        [
            [("Rutos Letter", 1), ("isadult", 0), ("Progressive Scale", [1])],
            [("Rutos Letter", 1), ("isadult", 0), ("Bomb Bag", 1)],
            [("Rutos Letter", 1), ("isadult", 0), ("has_spawn|ZD", 1)],
        ],
        ["item_update|Rutos Letter", "item_update|Bottle"],
    ),
    "Child Trade Sequence 1": (
        [("isadult", 0), ("child trade sequence", 0)],
        "item_update|child trade sequence",
    ),
    "Child Trade Sequence 2": (
        [("isadult", 0), ("child trade sequence", 1)],
        "item_update|child trade sequence",
    ),
    "Child Trade Sequence 3": (
        [("isadult", 0), ("child trade sequence", 2)],
        "item_update|child trade sequence",
    ),
    "Adult Trade Sequence 1": (
        [
            [("isadult", 1), ("adult trade sequence", 1), ("Hover Boots", 1)],
            [("isadult", 1), ("adult trade sequence", 1), ("Zeldas Lullaby", 1)],
        ],
        "item_update|adult trade sequence",
    ),
    "Adult Trade Sequence 2": (
        [("isadult", 1), ("adult trade sequence", 2)],
        "item_update|adult trade sequence",
    ),
    "Adult Trade Sequence 3": (
        [("isadult", 1), ("adult trade sequence", 3), ("has_access|Biggoron", 1)],
        "item_update|adult trade sequence",
    ),
    "Buy Magical Beans": (
        [
            [("isadult", 0), ("Bomb Bag", 1), ("Magic Bean", 0)],
            [("isadult", 0), ("Progressive Scale", [1]), ("Magic Bean", 0)],
            [("isadult", 0), ("has_spawn|ZR", 1)],
            [("isadult", 0), ("has_spawn|ZD", 1)],
        ],
        "item_update|Magic Bean",
    ),
}
