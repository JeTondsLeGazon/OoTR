...
mylogic = {
    ...
    "GV Crate Freestanding PoH":                             [[('isadult', 0)],
                                                              [('isadult', 1), ('Progressive Hookshot', 2)]],
    "GV Chest":                                              [[('isadult', 1), ('Eponas Song', 1), ('Megaton Hammer', 1)],
                                                              [('isadult', 1), ('Progressive Hookshot', 2), ('Megaton Hammer', 1)]],
    "GF Chest":                                              [[('isadult', 1), ('Eponas Song', 1), ('Progressive Hookshot', 1)],
                                                              [('isadult', 1), ('Progressive Hookshot', 2)],
                                                              [('isadult', 1), ('Eponas Song', 1), ('Hover Boots', 1)]],
    "GF HBA 1000 Points":                                    [('isadult', 1), ('Eponas Song', 1), ('Bow', 1)],
    "GF HBA 1500 Points":                                    [('isadult', 1), ('Eponas Song', 1), ('Bow', 1)],
    "Wasteland Chest":                                       [[('isadult', 1), ('Eponas Song', 1)],
                                                              [('isadult', 1), ('Progressive Hookshot', 2)]],
    ...
    "Shadow Temple Invisible Blades Visible Chest":          [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [1])],
    "Shadow Temple Invisible Blades Invisible Chest":        [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [1])],
    "Shadow Temple Falling Spikes Lower Chest":              [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [1])],
    "Shadow Temple Falling Spikes Upper Chest":              [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [1])],
    "Shadow Temple Falling Spikes Switch Chest":             [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [1])],
    "Shadow Temple Invisible Spikes Chest":                  [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [2])],
    "Shadow Temple Freestanding Key":                        [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [2]), ('Progressive Hookshot', [1])],
    "Shadow Temple Wind Hint Chest":                         [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [3]), ('Progressive Hookshot', [1])],
    "Shadow Temple After Wind Enemy Chest":                  [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [3]), ('Progressive Hookshot', [1])],
    "Shadow Temple After Wind Hidden Chest":                 [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [3]), ('Progressive Hookshot', [1])],
    "Shadow Temple Spike Walls Left Chest":                  [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [4]), ('Progressive Hookshot', [1]), ('Zeldas Lullaby', 1)],
    "Shadow Temple Boss Key Chest":                          [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [4]), ('Progressive Hookshot', [1]), ('Zeldas Lullaby', 1)],
    "Shadow Temple Invisible Floormaster Chest":                [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [4]), ('Progressive Hookshot', [1]), ('Zeldas Lullaby', 1)],
    "Shadow Temple Bongo Bongo Heart":                                     [[('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [5]), ('Progressive Hookshot', 1), ('Zeldas Lullaby', 1), ('Bow', 1), ('Boss Key (Shadow Temple)', 1)],
                                                              [('isadult', 1), ("has_access|Shadow", 1), ('Hover Boots', 1), ('Bomb Bag', 1), ("Small Key (Water Temple)", [5]), ('Progressive Hookshot', 2), ('Zeldas Lullaby', 1), ('Boss Key (Shadow Temple)', 1)]],
    ...
    "Gerudo Training Grounds Freestanding Key":              [[('isadult', 1), ("has_access|GTG", 1), ('Small Key (Gerudo Training Grounds)', [9])],
                                                              [('isadult', 1), ("has_access|GTG", 1), ('Progressive Hookshot', [1]), ('Song of Time', 1)],
                                                              [('isadult', 1), ("has_access|GTG", 1), ('Bomb Bag', 1), ('Song of Time', 1)]],
    "Gerudo Training Grounds Underwater Silver Rupee Chest": [('isadult', 1), ("has_access|GTG", 1), ('Progressive Hookshot', [1]), ('Song of Time', 1), ('Hover Boots', 1), ('Iron Boots', 1)],
...
additionnal_actions = {
    ...
    'Deliver RL': ([[('Rutos Letter', 1), ('isadult', 0), ('Progressive Scale', [1])],
                    [('Rutos Letter', 1), ('isadult', 0), ('Bomb Bag', 1)]], ["item_update|Rutos Letter", 'item_update|Bottle']),
    ...
    'Buy Magical Beans': ([[('isadult', 0), ('Bomb Bag', 1), ('Magic Bean', 0)],
                           [('isadult', 0), ('Progressive Scale', [1]), ('Magic Bean', 0)]], 'item_update|Magic Bean')
    }
