...
locations_table = [
    ...
    (
        ...
        "ZR",
        25,
        [[("Progressive Scale", [1])], [("isadult", 1), ("Iron Boots", 1)]],
    ),
    (
        "LW",
        "GC",
    ...
    ("ZD", "ZF", 30, [[("Rutos Letter", 2)], [("isadult", 1)]]),
    ...
    (
        ...
        "anywhere",
        10,
        [("Nocturne of Shadow", 1), ("Magic Meter", 1), ("Dins Fire", 1)],
    ),
    ("DMT", "Kak", 20, []),
    ...
    (
        ...
        20,
        [
            [("isadult", 1), ("Bomb Bag", 1), ("is_where|GC", 1)],
            [("isadult", 1), ("Bow", 1), ("is_where|GC", 1)],
    ...
    (
        ...
        "DMC Upper",
        20,
        [[("Bomb Bag", 1)], [("Megaton Hammer", 1), ("isadult", 1)]],
    ),
...
locations_to_zones = {
    ...
    "SFM": ["Song from Saria", "Sheik in Forest", "SFM Wolfos Grotto Chest"],
    "Forest Temple": [
        "Phantom Ganon",
    ...
    "GV GF Side": [
        "GV Waterfall Freestanding PoH",  # appears twice
        "GV Chest",
    ],
    "GV HF Side": ["GV Waterfall Freestanding PoH", "GV Crate Freestanding PoH"],
    "GF": ["GF Chest", "GF HBA 1000 Points", "GF HBA 1500 Points"],
    "GTG": [
    ...
    "DMC Lower": [
        "DMC Volcano Freestanding PoH",  # twice
        "Sheik in Crater",
    ],
    "Fire Temple": [
        "Volvagia",
    ...
    "LLR": ["Song from Malon", "LLR Talons Chickens", "LLR Freestanding PoH"],
    "LH": [
        "LH Underwater Item",
        "LH Sun",
        "LH Freestanding PoH",
    ...
    "Temple of Time": ["Sheik at Temple", "Time Travel"],
